    ...
    >
      <div className="text-center">
        ...
        <p className="mt-2 sm:mt-4">
          <strong className="text-3xl font-bold text-gray-900 sm:text-4xl"> 99rs </strong>
      ...
      <ul className="mt-6 space-y-2">
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Exclusive access to all the locked features </span>
        </li>
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Unlock the invite button & collaborate with friends </span>
        </li>
      ...
      <Link
        href="https://www.instagram.com/shuklaaman549/"
    ...
    <div className="rounded-2xl border border-gray-200 p-6 shadow-sm sm:px-8 lg:p-12">
      ...
      <ul className="mt-6 space-y-2">
        ...
        <li className="flex items-center gap-1">
          ...
          <span className="text-gray-700"> Limited access to JointJot </span>
        </li>
