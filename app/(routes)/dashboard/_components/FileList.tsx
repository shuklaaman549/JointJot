...
import { Angry, Archive, Meh, MoreHorizontal, Settings, Smile } from 'lucide-react';
...
<div className="overflow-x-auto">
  ...
  <DropdownMenuContent>
    ...
    <DropdownMenuItem className='gap-3'>
       <Smile className='h-4 w-4'/> Happy</DropdownMenuItem>
       <DropdownMenuItem className='gap-3'>
       <Meh className='h-4 w-4'/> Normal</DropdownMenuItem>
       <DropdownMenuItem className='gap-3'>
       <Angry className='h-4 w-4'/> Disappointed</DropdownMenuItem>
